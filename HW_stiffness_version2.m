function [res,k_num,k_model,ks_mean,k_model_low,l_chrom,l_index,f_num]=HW_stiffness_version2(d,f,f_lbound,f_ubound,k_threshold)
...
[l_chrom, l_index]=length_from_stiffness(d_num./1000,f_num,k_num,k_threshold);
