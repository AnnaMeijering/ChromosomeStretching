...
if beadtrackdistance(1) == 0
    prompt = {'No bead tracking was detected. Enter distance between beads from BF image. :',
        'Enter pulling speed in um/s:','Enter sample age in days:'};
    title = 'Input';
    dims = [1 35];
    definput = {'0','0.05','1'};
...
%%
beadtrackdistanceC=beadtrackdistance-4.65;
subplot(2,1,1);
plot(forceCH1(2600:4100))

subplot(2,1,2);
plot(beadtrackdistanceC(2600:4100))
hold on
plot(trap_distance{7})